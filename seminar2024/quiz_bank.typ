...
#let Quiz = Quiz_create(
  ...
  quiz("Q7.5", question:[
    ２プレイヤー $times$ 2戦略のゲームを Rgamer を用いて100個作成しなさい．ただし，利得はランダムにすること．
  ], answer:[
  ...
  quiz("Q19", question:[
   ...
   quiz("Q15.1", question:[
    （記憶力のないプレイヤーたちによるムカデゲーム）次のゲームの木で表されるゲームの純粋戦略サブゲーム完全均衡をすべて求めなさい．ただし，同じ曲線で繋がれたノードは同じ情報集合に属するとする．
    #align(center)[
    #cetz.canvas({
    import cetz.draw: *
    line((0,0),(10,0), mark:(end:"straight"))
    ...
    content( (10,0), [$(3,5)$], anchor:"west",padding:(x:2mm))
    hobby((0, 0), (1, 1),  (4.04, 0), omega: 0, stroke: blue+2pt)
    hobby((4, 0), (5, 1),  (8, 0), omega: 0, stroke: blue+2pt)
    hobby((2, 0), (5, -.3),  (6, 0), omega: 0, stroke: red+2pt)
  }  
